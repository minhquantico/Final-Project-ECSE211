...
public class UltrasonicLocalizer /*implements Runnable*/ {
  ...
  /**
   * Relocalize is used to localize the robot after it has already starting moving. This method
   * readjusts the X and Y values by by turning to 180 and 270 degrees and measuring the 
   * corresponding distance values.
   */
  public void relocalize() {
    // Update Y.
    navigation.turnTo(180);
    odometer.setY(getFilteredDistance());
    // Update X.
